<x-app-layout>
    <x-slot name="header">
        <h2 class="text-2xl font-bold text-gray-900">Edit Member</h2>
    </x-slot>
        ...
        <form action="{{ route('members.update', $member->id) }}" method="POST" class="space-y-8">
            ...
            <div class="p-6 bg-white border border-gray-200 shadow-md rounded-xl">
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-700">Trainer</label>
                    ...
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-700">Join Date</label>
            ...
            <div class="p-6 bg-white border border-gray-200 shadow-md rounded-xl">
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-700">Plan</label>
                    ...
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-700">Subscription Status</label>
